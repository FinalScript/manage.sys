    ...
    useEffect(() => {
        ...
        switch (sortValue) {
            ...
            case 'wage':
                ...
                break;
            case 'status':
                copy.sort((a, b) => (!sortAsc ? a.status.localeCompare(b.status) : b.status.localeCompare(a.status)));
                break;
            case 'startingDate':
                copy.sort((a, b) => (!sortAsc ? a.startingDate.localeCompare(b.startingDate) : b.startingDate.localeCompare(a.startingDate)));
                break;
            default:
                break;
        }
