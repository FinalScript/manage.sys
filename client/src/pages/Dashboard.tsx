...
export const Dashboard = () => {
    ...
    return (
        <div ref={mounted} className='min-h-screen h-full bg-gray-800 text-white pt-20 pb-20 flex flex-col items-center'>
            ...
            <div className='bg-gray-900 container mt-14 p-7 rounded-xl'>
                ...
                <div>
                    {storeData.map((store) => {
                        return (
                            <div key={store.id} className='flex space-x-2 mb-3 bg-gray-800 rounded-xl'>
