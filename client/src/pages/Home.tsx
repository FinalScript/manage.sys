...
export const Home = () => {
    ...
    return (
        <div className='h-full bg-white dark:bg-gray-800 text-white'>
            <section className='text-gray-500 dark:text-gray-400 body-font pt-40  flex items-center'>
                <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
                    ...
                    <div className='lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center'>
                        <h1 className='mb-5 title-font sm:text-5xl text-3xl font-medium text-gray-900 dark:text-white'>
                            The only management system you need
                            <span className='mt-3 block'></span>
                        </h1>
                        <p className='mb-8 leading-relaxed'>
                            Safe, Manageable, Secure. Save all your stores and employees in one place, with representations of the most used currencies around
                            the world.
                        </p>
            ...
            <section className='text-gray-500 dark:text-gray-400  body-font pt-28'>
