...
export const Nav = () => {
    ...
    return (
        <header className='text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-900 body-font fixed w-full z-10'>
            <div className='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center'>
                ...
                {authData ? (
                    <>
                        ...
                        <button
                            onClick={logout}
                            className='inline-flex items-center bg-pink-600 text-white border-0 py-1 px-3 focus:outline-none hover:bg-pink-700 rounded text-base mt-4 md:mt-0'>
                            Logout
                        </button>
                    </>
                ) : (
