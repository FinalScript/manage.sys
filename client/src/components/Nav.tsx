    ...
    return (
        <header className='text-gray-400 bg-gray-900 body-font fixed w-full'>
            <div className='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center'>
                ...
                <Link to={"/auth"} className='inline-flex items-center bg-teal-300 text-black border-0 py-1 px-3 focus:outline-none hover:bg-teal-500 rounded text-base mt-4 md:mt-0'>
                    Sign Up
                    <svg
                        fill='none'
                        stroke='currentColor'
